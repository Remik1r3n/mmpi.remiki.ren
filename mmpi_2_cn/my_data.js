 ...
 */
 ...
 questions = [
  ...
  questions_zh = [
    ...
    "我经常感觉喉咙像是被堵住了一样。",
    "我对我的性生活很满意。",
    "我认为梦都是有意义的，我们应该去认真思考它在启发或警告我们什么。",
    "我喜欢刑侦类的电影、小说等。",
    "我的生活节奏很紧张。",
    "有时我会幻想一些非常恶劣的事情。",
    "生活对我不公。",
    ...
    "我曾因为不良行为在学校里被约谈。",
    "我讲话和以前并没有出现什么差别（没有加快或减慢，没有口齿不清或嘶哑）。",
    "我在家里的时候没那么讲餐桌礼仪。",
    ...
    "我从未沉迷于淫乱放荡的事情。",
    "有时我思绪奔涌，超过我说话的速度。",
    "如果我在电影院能逃票看一场电影，且一定不会被别人发现，我大概会这么干。",
